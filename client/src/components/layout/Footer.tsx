...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/paymentgateway',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/paymentgateway',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/paymentgateway',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md">
              Secure payment processing platform for businesses of all sizes. 
              Accept payments online with our reliable and fast payment gateway.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400">
              © {currentYear} PaymentGateway. All rights reserved.
            </div>
          </div>
        </div>
      </div>
